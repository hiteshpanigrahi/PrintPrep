  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="animate-rise relative w-full max-w-md overflow-hidden rounded-3xl border border-[var(--border-color)] bg-[var(--bg-panel)] p-8 text-center shadow-2xl">
        ...
        {!submitted ? (
          <>
            <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-full bg-[var(--mint)] text-[var(--accent-mint)]">
                ...
                >
                  <Star
                    ...
                    className={`transition-colors ${
                      (hovered || rating) >= val
                        ? "fill-[var(--accent-mint)] text-[var(--accent-mint)]"
                        : "fill-transparent text-[var(--border-color)] hover:text-[var(--mint)]"
                    }`}
                  />
                </button>
              ))}
